...
export default function Retouched() {
  ...
  `}</style> 
     <div id="retouched" className="container mx-auto ">
       <h1 className='text-[40px] md:text-[50px] py-5 sm:py-20 xl:text-[60px] text-center title font-tartuffo-bold-italic leading-[100%]'>Our AI Tools</h1>
